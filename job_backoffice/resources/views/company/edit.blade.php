            ...
            {{-- component abouve formAction --}}
                ...
                <div class="mb-4 p-6 bg-gray-50 border-gray-100 rounded-lg shadow">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="industry" id="industry" valiue="{{ old('industry') . $company->industry }}"
                    ...
                    <div class="mb-4 p-2 bg-gray-50">
                        ...
                        <div class="mb-4">
                            ...
                            <input disabled type="email" name="owner_email" id="owner_email"
                                ...
                                class="{{ $errors->has('Owner_email') ? 'border-red-500' : ''}} block w-full p-2 border border-gray-300 rounded-md shadow-sm sm:text-sm bg-gray-100"
                                placeholder="Enter Company Owner email">
                            @error('Owner_email')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            <label for="Owner_password" class="block mb-2 text-sm font-medium text-gray-700">Owner
                                change Owner Password(leave empty for no change)</label>
