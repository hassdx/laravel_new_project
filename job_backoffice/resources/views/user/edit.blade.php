<x-app-layout>
    ...
    <div class="overflow-x auto p-6">
        <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow">
            <form action="{{ route('users.update', ['user' => $user->id]) }}" class="w-full"
                enctype="multipart/form-data" accept-charset="UTF-8" id="edit-user-form-{{ $user->id }}" method="POST">
                @csrf
                @method('PUT')
                
                @if ($errors->any())
                    <div class="mb-4 p-4 bg-red-100 border-l-4 border-red-500 text-red-700">
                        <p class="font-bold">Check these errors:</p>
                ...
                <div class="mb-4 p-6 bg-gray-50 border-gray-100 rounded-lg shadow">
                    <h3 class="text-lg font-large ">user details</h3>
                    ...
                    <div class="mb-4">
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-700">Position (Job
                            Vacancy)</label>
                        <span>{{ $user->role }}</span>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative" x-data="{ showPassword: false }">
                            ...
                            <button type="button" class="absolute insert-y-0 right-2 flex items-center text-gray-600 ">
                                {{-- eye closed --}}
                    ...
                    <div class="flex justify-end items-center">
                        <a href="{{ route('users.index', ) }}" class="text-gray-700 mr-2 ">Cancel</a>
                        <button type="submit"
